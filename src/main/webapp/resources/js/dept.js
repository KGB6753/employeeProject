...
var deptService = (function () {
  function getDeptList(callback, error) {
    $.getJSON("/rest/department.json", function (data) {
      if (callback) {
        callback(data);
      }
  ...
  function getDeptTitleList(dept_no, callback, error) {
    $.getJSON("/rest/department/titles/" + dept_no + ".json", function (data) {
      if (callback) {
        callback(data);
      }
    }).fail(function (xhr, status, err) {
  ...
  function getDeptEmpList(emp_no, callback, error) {
    $.getJSON("/rest/department/employee/" + emp_no + ".json", function (data) {
      if (callback) {
        callback(data);
      }
    }).fail(function (xhr, status, err) {
  ...
  function getTitleList(emp_no, callback, error) {
    $.getJSON(
      "/rest/department/employee/title/" + emp_no + ".json",
      function (data) {
        if (callback) {
          callback(data);
        }
